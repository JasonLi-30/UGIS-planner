...
// 静态地图生成函数（线程安全）
std::vector<Eigen::MatrixXd> my_planner::UGIS_Planner::createOccupancyMapVolumeStatic(
...
bool my_planner::UGIS_Planner::solve(const planning_scene::PlanningSceneConstPtr& planning_scene,
                         ...
                         planning_interface::MotionPlanDetailedResponse& res) const
{
    ...
    const std::string MODEL_PATH = "/home/jasonli/ws_moveit2/src/moveit2/moveit_planners/UGIS_planner/UGIS_planner_motion_planner/src/best_ppo_sampler_model_quantized.onnx";
    ...
    std::string config_path = "/home/jasonli/ws_moveit2/UGIS_config.json";
    ...
    try 
    {
        ...
        if (config_file.is_open()) {
            ...
            model_joints_ = j.value("model_joints", -1);
            ...
            std::cout << "model_joints: " << model_joints_ << std::endl;
            std::cout << "=============================" << std::endl;
        }
    } 
    ...
    while (count < loopNum)
    {
        ...
        my_planner::UGIS_Trajectory trajectory(planning_scene_current->getRobotModel(), 3.0, .03, req.group_name);
        ...
        my_planner::UGIS_Parameters params_nonconst = params;
        std::unique_ptr<my_planner::UGIS> planner = std::make_unique<my_planner::UGIS>(
        ...
        planner->model_joints_ = model_joints_;
